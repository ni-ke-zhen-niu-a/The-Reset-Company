...
const copy = {
  en: {
    ...
    viewSource: 'View on X', detected: 'Detected', lastChecked: 'Last checked',
  ...
  'zh-CN': {
    ...
    viewSource: '在 X 查看', detected: '发现时间', lastChecked: '最后检查',
  ...
  ja: {
    ...
    viewSource: 'X で見る', detected: '検出', lastChecked: '最終確認',
  ...
  es: {
    ...
    viewSource: 'Ver en X', detected: 'Detectado', lastChecked: 'Última comprobación',
  ...
  de: {
    ...
    viewSource: 'Auf X ansehen', detected: 'Erkannt', lastChecked: 'Zuletzt geprüft',
  ...
  fr: {
    ...
    viewSource: 'Voir sur X', detected: 'Détecté', lastChecked: 'Dernière vérification',
  ...
  pt: {
    ...
    viewSource: 'Ver no X', detected: 'Detectado', lastChecked: 'Última verificação',
