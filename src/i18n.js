...
const copy = {
  en: {
    ...
    rolloutObserved: 'Observed rolling out early', rolloutLive: 'RESET IS ROLLING OUT EARLY', rolloutLiveBody: 'The reset is already appearing on some accounts ahead of the announced estimate. Rollout may still be gradual.',
    estimated: 'Temporary estimate (8pm PT eligibility cutoff)', estimatedLive: 'ESTIMATED RESET TIME HAS PASSED', estimatedLiveBody: '8pm PT was an eligibility cutoff, used temporarily until Tibo confirms the reset status or a precise time.',
    confidenceJoke: "Tibo has final say on time confidence. (doge)",
    resetNotYet: 'Not yet.', resetPressed: 'Reset pressed.', tiboAlt: 'Saint Tibo reaching toward the reset button',
  ...
  'zh-CN': {
    ...
    rolloutObserved: '已观察到提前生效', rolloutLive: '重置正在提前生效', rolloutLiveBody: '已有账户在推定时间前观察到重置生效，可能仍在分批下发。',
    estimated: '临时推定（8pm PT 资格截止时间）', estimatedLive: '临时推定时间已到', estimatedLiveBody: '8pm PT 原本是资格截止时间；在 Tibo 确认状态或精确时间前，暂用作倒计时目标。',
    confidenceJoke: '时间置信度由 Tibo 拥有最终解释权（doge）',
    resetNotYet: '时辰未到。', resetPressed: '重置已按下。', tiboAlt: '圣像风格的 Tibo 正伸手靠近重置按钮',
  ...
  ja: {
    ...
    rolloutObserved: '早期反映を確認', rolloutLive: 'リセットが早期に反映中', rolloutLiveBody: '予定時刻より前に一部のアカウントで反映が確認されています。段階的な配布の可能性があります。',
    estimated: '暫定推定（8pm PT の資格期限）', estimatedLive: '暫定時刻を過ぎました', estimatedLiveBody: '8pm PT は資格期限です。Tibo が状態または正確な時刻を確認するまで暫定的に使用します。',
    confidenceJoke: '時刻の信頼度に関する最終解釈権は Tibo にあります。（doge）',
    resetNotYet: 'まだです。', resetPressed: 'リセットが押されました。', tiboAlt: 'リセットボタンへ手を伸ばす聖人風の Tibo',
  ...
  es: {
    ...
    rolloutObserved: 'Despliegue anticipado observado', rolloutLive: 'EL REINICIO SE ESTÁ DESPLEGANDO ANTES', rolloutLiveBody: 'El reinicio ya aparece en algunas cuentas antes de la hora estimada. El despliegue puede ser gradual.',
    estimated: 'Estimación temporal (límite de elegibilidad: 8pm PT)', estimatedLive: 'LA HORA ESTIMADA YA PASÓ', estimatedLiveBody: 'Las 8pm PT eran el límite de elegibilidad; se usan temporalmente hasta que Tibo confirme el estado o una hora exacta.',
    confidenceJoke: 'Tibo tiene la última palabra sobre la confianza horaria. (doge)',
    resetNotYet: 'Todavía no.', resetPressed: 'Reinicio pulsado.', tiboAlt: 'San Tibo extendiendo la mano hacia el botón de reinicio',
  ...
  de: {
    ...
    rolloutObserved: 'Vorzeitige Aktivierung beobachtet', rolloutLive: 'RESET WIRD VORZEITIG AUSGEROLLT', rolloutLiveBody: 'Der Reset ist vor dem Schätzzeitpunkt bereits bei einigen Konten sichtbar. Der Rollout kann schrittweise erfolgen.',
    estimated: 'Vorläufige Schätzung (Teilnahmeschluss 20 Uhr PT)', estimatedLive: 'GESCHÄTZTER ZEITPUNKT IST VORBEI', estimatedLiveBody: '20 Uhr PT war der Teilnahmeschluss und dient nur vorläufig, bis Tibo Status oder genaue Zeit bestätigt.',
    confidenceJoke: 'Tibo hat das letzte Wort zur Zeitgenauigkeit. (doge)',
    resetNotYet: 'Noch nicht.', resetPressed: 'Reset gedrückt.', tiboAlt: 'Der heilige Tibo greift nach dem Reset-Knopf',
  ...
  fr: {
    ...
    rolloutObserved: 'Déploiement anticipé observé', rolloutLive: 'DÉPLOIEMENT ANTICIPÉ EN COURS', rolloutLiveBody: 'La réinitialisation apparaît déjà sur certains comptes avant l’heure estimée. Le déploiement peut être progressif.',
    estimated: 'Estimation provisoire (limite d’éligibilité à 20 h PT)', estimatedLive: 'L’HEURE ESTIMÉE EST PASSÉE', estimatedLiveBody: '20 h PT était la limite d’éligibilité, utilisée provisoirement jusqu’à la confirmation de Tibo.',
    confidenceJoke: "Tibo a le dernier mot sur la fiabilité de l’heure. (doge)",
    resetNotYet: 'Pas encore.', resetPressed: 'Réinitialisation activée.', tiboAlt: 'Saint Tibo tendant la main vers le bouton de réinitialisation',
  ...
  pt: {
    ...
    rolloutObserved: 'Ativação antecipada observada', rolloutLive: 'REDEFINIÇÃO SENDO LIBERADA ANTES', rolloutLiveBody: 'A redefinição já aparece em algumas contas antes do horário estimado. A liberação pode ser gradual.',
    estimated: 'Estimativa temporária (limite de elegibilidade: 20h PT)', estimatedLive: 'O HORÁRIO ESTIMADO JÁ PASSOU', estimatedLiveBody: '20h PT era o limite de elegibilidade e é usado provisoriamente até Tibo confirmar o estado ou um horário exato.',
    confidenceJoke: 'Tibo tem a palavra final sobre a confiança do horário. (doge)',
    resetNotYet: 'Ainda não.', resetPressed: 'Redefinição pressionada.', tiboAlt: 'São Tibo estendendo a mão para o botão de redefinição',
